                    ...
                    <div class="col">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$customersBalance < 0 ? "text-danger" : "text-success"}}">{{number_format($customersBalance, 0)}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$vendorsBalance < 0 ? "text-danger" : "text-success"}}">{{number_format($vendorsBalance, 0)}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22 {{$myBalance < 0 ? "text-danger" : "text-success"}}">{{number_format($myBalance, 0)}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
                    <div class="col">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h2 class="mb-0 cfs-22">{{number_format(stockValue(), 0)}}</h2>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col -->
